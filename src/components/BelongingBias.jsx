...
function BelongingBias() {
    return (
        <div className="project">
            ...
            <p>I worked with two other students to conduct a human-computer interaction research study on the effects of biased web design. We studied the impact of stereotypical color, language, and imagery in a computer science course website on women’s interest and belonging in computer science.</p>
