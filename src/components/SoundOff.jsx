...
function JobsBoard() {
    return (
        <div className="project">
            ...
            <h2>Outcome</h2>
            <p>During my class’s demo day, several people tried out my game. I learned that the instructions were easy to miss, so I should’ve created a separate screen with the instructions right in front of their eyes. People seemed to enjoy clicking the sounds away once they learned how the game worked.</p>
            </p>
        </div>
    );
}
